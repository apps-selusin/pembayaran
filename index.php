...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 't00_sekolah'))
			$this->Page_Terminate("t00_sekolahlist.php");
		if ($Security->AllowList(CurrentProjectID() . 't01_kelas'))
			$this->Page_Terminate("t01_kelaslist.php");
		if ($Security->AllowList(CurrentProjectID() . 't02_siswa'))
			$this->Page_Terminate("t02_siswalist.php");
