...
$RootMenu->AddMenuItem(5, "mi_t96_employees", $Language->MenuPhrase("5", "MenuText"), "t96_employeeslist.php", 8, "", AllowListMenu('{DCB8868F-2909-4349-AFEF-80A438B4A06C}t96_employees'), FALSE, FALSE);
$RootMenu->AddMenuItem(6, "mi_t97_userlevels", $Language->MenuPhrase("6", "MenuText"), "t97_userlevelslist.php", 8, "", (@$_SESSION[EW_SESSION_USER_LEVEL] & EW_ALLOW_ADMIN) == EW_ALLOW_ADMIN, FALSE, FALSE);
