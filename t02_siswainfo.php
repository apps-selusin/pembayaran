...
//
// Table class for t02_siswa
//
class ct02_siswa extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't02_siswa';
		$this->TableName = 't02_siswa';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t02_siswa`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t02_siswa', 't02_siswa', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// sekolah_id
		$this->sekolah_id = new cField('t02_siswa', 't02_siswa', 'x_sekolah_id', 'sekolah_id', '`sekolah_id`', '`sekolah_id`', 3, -1, FALSE, '`sekolah_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kelas_id
		$this->kelas_id = new cField('t02_siswa', 't02_siswa', 'x_kelas_id', 'kelas_id', '`kelas_id`', '`kelas_id`', 3, -1, FALSE, '`kelas_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Nomor_Induk
		$this->Nomor_Induk = new cField('t02_siswa', 't02_siswa', 'x_Nomor_Induk', 'Nomor_Induk', '`Nomor_Induk`', '`Nomor_Induk`', 200, -1, FALSE, '`Nomor_Induk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nomor_Induk->Sortable = TRUE; // Allow sort
		$this->fields['Nomor_Induk'] = &$this->Nomor_Induk;

		// Nama
		$this->Nama = new cField('t02_siswa', 't02_siswa', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t02_siswa`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t02_siswaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t02_siswaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t02_siswaadd.php?" . $this->UrlParm($parm);
		else
			$url = "t02_siswaadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t02_siswaedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t02_siswaadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t02_siswadelete.php", $this->UrlParm());
	}
